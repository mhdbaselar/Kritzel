...
module.exports = class Board {
   ...
   * @param {int} initialColor color code in int notation
   */
  ...
  /**
   * Draws an int color code to given coordinate with given thickness in each direction
  ...
  /**
   * Erase an int color code to given coordinate with given thickness in each direction to background color
   * @param {int} x coordinate
   * @param {int} y coordinate
   * @param {int} color int color code
   * @param {int} thickness thickness
   ...
   * @param {int} y coordinate
   * @param {int} color int color code
   * @param {int} previousColor previous color from fill mouse click
   */
  ...
  /**
   * Sets a int color code to all positions in the 2D array (this.#canvas)
   * @param {int} color int color code
   */
  #setWholeBoard(color) {
